public class Main {
    public static void main(String[] args) {
        //Vrem sa creem 2 mamifere 2 ierbivore , 2 carnivore , 5 animale terestre ,2 animale
        ...
        TerestrialAnimals terestrialAnimal1=new TerestrialAnimals("green",0,"snake","Taras",true);
        TerestrialAnimals terestrialAnimal2=new TerestrialAnimals("grey",4,"Elefant","Merge incet",false);
        TerestrialAnimals terestrialAnimal3=new TerestrialAnimals("black",4,"Panter","Alearga",true);
        ...
        HerbivoreAnimal erbivorAnimal1=new HerbivoreAnimal("Orange",4,"deer","Alearga",false,true);
        HerbivoreAnimal erbivorAnimal2=new HerbivoreAnimal("brown",4,"arici","Merge incet",false,true);

        //2 mamifere
        Mamels mamel1=new Mamels("White",4,"zebra","alearga",false,1);
        Mamels mamel2=new Mamels("Brown",4,"horese","Alearga",false,1);
